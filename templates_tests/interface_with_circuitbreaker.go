...
//go:generate gowrap gen -p github.com/SergiiShapoval/gowrap/templates_tests -i TestInterface -t ../templates/circuitbreaker -o interface_with_circuitbreaker.go
