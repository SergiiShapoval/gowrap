...
//go:generate gowrap gen -p github.com/SergiiShapoval/gowrap/templates_tests -i InterfaceWithValidtableArg -t ../templates/validate -o interface_with_validation.go
